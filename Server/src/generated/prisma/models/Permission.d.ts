...
export type PermissionWhereInput = {
    ...
    perid?: Prisma.IntFilter<"Permission"> | number;
    pername?: Prisma.StringFilter<"Permission"> | string;
    status?: Prisma.IntFilter<"Permission"> | number;
};
export type PermissionOrderByWithRelationInput = {
    perid?: Prisma.SortOrder;
    pername?: Prisma.SortOrder;
...
export type PermissionScalarWhereWithAggregatesInput = {
    ...
    perid?: Prisma.IntWithAggregatesFilter<"Permission"> | number;
    pername?: Prisma.StringWithAggregatesFilter<"Permission"> | string;
    status?: Prisma.IntWithAggregatesFilter<"Permission"> | number;
};
...
export type PermissionUpdateInput = {
    pername?: Prisma.StringFieldUpdateOperationsInput | string;
    status?: Prisma.IntFieldUpdateOperationsInput | number;
};
export type PermissionUncheckedUpdateInput = {
    perid?: Prisma.IntFieldUpdateOperationsInput | number;
    pername?: Prisma.StringFieldUpdateOperationsInput | string;
    status?: Prisma.IntFieldUpdateOperationsInput | number;
};
...
export type PermissionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"perid" | "pername" | "status", ExtArgs["result"]["permission"]>;
...
export interface PermissionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     *
     * // Only select the `perid`
     * const permissionWithPeridOnly = await prisma.permission.findMany({ select: { perid: true } })
     *
     */
...
export interface PermissionFieldRefs {
    readonly perid: Prisma.FieldRef<"Permission", 'Int'>;
    readonly pername: Prisma.FieldRef<"Permission", 'String'>;
    readonly status: Prisma.FieldRef<"Permission", 'Int'>;
}
/**
