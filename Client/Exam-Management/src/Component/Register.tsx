                ...
                <div className="flex  justify-center w-screen bg-[#2563EB] ">
                    <div className=" flex flex-col text-center  mt-[15vh] p-10 h-[65vh] rounded-xl bg-white">
                        ...
                        <div className="flex justify-between">
                            ...
                            <button className="!bg-gray-100 !font-bold flex items-center justify-center h-[3.5vh]"><img src="/user.png" className="mr-[0.5vw]"/> <Link to="/auth/login" className="!text-black !font-bold">Đăng Nhập </Link></button>
