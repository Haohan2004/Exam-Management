...
const EditGroupForm = ({group,seteditform,fetchgroup}:EditGroupProps) =>{
        ...
        <>
            <div className="  border-1 w-[25vw] h-[25vh] flex-col  rounded-[10px] overflow-hidden bg-white">
                <div className="w-full h-[20%]  p-[10px] bg-blue-500 ">
                    <p className="text-[2vh]    text-white font-['Roboto']">Sửa tổ hợp môn</p>
                </div>
                <div className="p-[3vh]">
                    <p>Tên tổ hợp</p>
                ...
                <div className="flex items-center justify-center">
                    <Button color="primary" variant="solid" className="mx-4" onClick={(e:React.MouseEvent)=>{addgroup(e)}} >Lưu</Button>
